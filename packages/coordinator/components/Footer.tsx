...
const navigation = [
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/pasosdeJesus/stable-sl',
    icon: (props: Props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
...
export default function Footer() {
  return (
    <footer className="bg-baseclear mt-auto border-black border-t">
      <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-base text-black">
            Developed by <a href="">Pasos de Jesús</a>.  {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
